...
java -cp .;"<your_path>\kinetica-jdbc-7.0.0.0-SNAPSHOT-jar-with-dependencies.jar" com.gisfederal.gpudbquery.JDBCSample -DriverClass com.kinetica.jdbc.Driver -URL "jdbc:kinetica://gpudb-machine-name-or-ip:9191" -PWD pwd -UID uid

Example invocation - C:\1GAIA\gpudb-client-jdbc\JDBCSample\target>java -cp .;gpudb-java-sample-0.1.0-jar-with-dependencies.jar;..\..\JDBCDriver\kinetica-jdbc-7.0.0.0-SNAPSHOT-jar-with-dependencies.jar com.gisfederal.gpudbquery.JDBCSample -DriverClass com.kinetica.jdbc.Driver -URL "jdbc:kinetica://gpudb-machine-name-or-ip:9191" -PWD pwd -UID uid
...
Please note the kinetica-jdbc-7.0.0.0-SNAPSHOT-jar-with-dependencies.jar has to be in the classpath and this jar is available as part of this repo under the directory connectors/jdbc.
