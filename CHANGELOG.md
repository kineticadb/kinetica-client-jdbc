...
#### Added
-   Passing of driver name & version in HTTP headers.
...
#### Changed
-   Skip extra call to the database for prepare-mode inserts.
-   Upgraded Logback library to 1.3.16.
-   Updated underlying Java API to 7.2.3.15.
...
-   Updated underlying Java API to 7.2.3.14.
...
#### Changed
-   Updated underlying Java API to 7.2.3.10.


### Version 7.2.3.9 - 2025-12-18

#### Changed
-   Updated underlying Java API to 7.2.3.9.
...
-   Updated underlying Java API to 7.2.3.6.
